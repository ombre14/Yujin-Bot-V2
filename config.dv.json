{
	...
	"antiInbox": false,
	"language": "fr",
	"notesLanguage": "change to your language with ISO 639-1 code, available languages: fr (French), en (English)",
	"nickNameBot": "[@] ᎠᎯᎬᎷᎾᏁ-ᏰᎾᎿ",
	"prefix": "@",
	"adminOnly": {
		"enable": false,
		"ignoreCommand": []
	},
	"adminBot": [100085096696396],
	"whiteListMode": {
		"enable": false,
		"whiteListIds": [],
